...
def updateEscola(id):
    ...
    try:
        ...
        nome = escola['nome']
        print(nome)
        logradouro =aluno escola['logradouro']
        print(logradouro)
        cidade = escola['cidade']
        print(cidade)
...
def setAluno():from flask import Flask, request, jsonify
from flask_json_schema import JsonSchema, JsonValidationError
import sqlite3
import logging
...
def updateDisciplina(id):
    ...
    try:
        ...
        conn.close()from flask import Flask, request, jsonify
from flask_json_schema import JsonSchema, JsonValidationError
import sqlite3
import logging
